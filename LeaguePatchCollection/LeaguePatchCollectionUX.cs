...
namespace LeaguePatchCollection
{
    public partial class LeaguePatchCollectionUX : Form
    {
        ...
        {
            MessageBox.Show("Ban reason pulled from login queue endpoint: " + HttpProxy.banReason, "League Patch Collection", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
